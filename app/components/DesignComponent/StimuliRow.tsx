...
export default class StimuliRow extends Component<Props> {
  ...
  render() {
    return <Table.Row className={styles.trialsRow}>
        ...
        <Table.Cell className={styles.experimentRowName}>
          <Form.Select fluid selection value={this.props.response} onChange={(event, data) => this.props.onChange(this.props.num, 'response', data.value)} placeholder='Response' options={RESPONSE_OPTIONS} />
        </Table.Cell>

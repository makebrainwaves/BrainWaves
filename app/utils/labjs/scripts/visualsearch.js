...
for (let i = 1; i <= numberTrials; i++){
  practiceTrialParameters = practiceTrialParameters.concat(trialConstructor(i, 5, 'yes'))
  practiceTrialParameters = practiceTrialParameters.concat(trialConstructor(i, 5, 'no'))
  practiceTrialParameters = practiceTrialParameters.concat(trialConstructor(i, 10, 'yes'))
  practiceTrialParameters = practiceTrialParameters.concat(trialConstructor(i, 10, 'no'))
  practiceTrialParameters = practiceTrialParameters.concat(trialConstructor(i, 15, 'yes'))
  practiceTrialParameters = practiceTrialParameters.concat(trialConstructor(i, 15, 'no'))
  practiceTrialParameters = practiceTrialParameters.concat(trialConstructor(i, 20, 'yes'))
  practiceTrialParameters = practiceTrialParameters.concat(trialConstructor(i, 20, 'no'))
}
...
this.data.response_given = (this.parameters.phase === 'practice' || this.state.response === 'noresponse') ? 'no' : 'yes';
}
                },
                "title": "Feedback",

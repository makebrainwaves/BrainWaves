...
!(function(t, n) {
  ...
  return (function(t) {
      ...
      var r = e(2),
        ...
        $ = function(t, n, e) {
          return (
            ...
            o(D, n)
              ? (e.enumerable
                  ? (o(t, C) && t[C][n] && (t[C][n] = !1), (e = S(e, { enumerable: O(0, !1) })))
        ...
        X = function(t, n) {
          if (((t = w(t)), (n = x(n, !0)), t !== U || !o(D, n) || o(B, n))) {
            var e = P(t, n);
            return !e || !o(D, n) || (o(t, C) && t[C][n]) || (e.enumerable = !0), e;
          }
        },
        K = function(t) {
        ...
        Q = function(t) {
          for (var n, e = t === U, r = T(e ? B : w(t)), i = [], a = 0; r.length > a; )
      ...
      if (e(8)) {
        var r = e(49),
          ...
          Ct = {
            ...
            filter: function(t) {
              return Et(this, X(jt(this), t, arguments.length > 1 ? arguments[1] : void 0));
            },
            find: function(t) {
            ...
            reverse: function() {
              for (var t, n = jt(this).length, e = Math.floor(n / 2), r = 0; r < e; )
          ...
          (t.exports = function(t, n, e, s) {
            ...
            b
              ...
              : (i(function() {
                ...
                Y(m !== Function.prototype ? k(g).concat(k(m)) : k(g), function(t) {
                  t in d || p(d, t, g[t]);
                }),
                (d.prototype = S),
                r || (S.constructor = d));
            ...
            (i._invoke = (function(t, n, e) {
              ...
              return function(o, i) {
                ...
                for (e.method = o, e.arg = i; ; ) {
                  ...
                  'throw' === s.type && ((r = h), (e.method = 'throw'), (e.arg = s.arg));
                }
              };
            })(t, e, a)),
            i
      ...
      t.exports = {
        set:
          ...
          ('__proto__' in {}
            ? (function(t, n, r) {
                try {
                  (r = e(32)(Function.call, e(27).f(Object.prototype, '__proto__').set, 2))(t, []),
      ...
      (R[E] = R['[object Array]'] = R['[object ArrayBuffer]'] = R['[object DataView]'] = R[
        ...
        (t.exports = function t(n, e, M, F, C, I) {
          ...
          if (U) {
            ...
            if (b(n)) return s(n, N);
            if (z == T || z == E || (q && !C)) {
              if (((L = D || q ? {} : g(n)), !N)) return D ? l(n, u(L, n)) : f(n, a(L, n));
            } else {
              if (!R[z]) return C ? n : {};
              L = y(n, z, N);
            }
    ...
    function(t, n, e) {
      'use strict';
      (function(t) {
        e(13), e(20), e(44), e(42), e(17), e(15), e(14), e(19), e(7), e(16), e(63), e(60);
        var r = e(37),
          o = e.n(r);
        function i(t) {
          return (
          ...
          return (
            ...
            (this._initBody = function(t) {
              if (((this._bodyInit = t), t))
                ...
                else if (n.searchParams && URLSearchParams.prototype.isPrototypeOf(t))
                  this._bodyText = t.toString();
                else if (n.arrayBuffer && n.blob && r(t))
                  (this._bodyArrayBuffer = d(t.buffer)),
                    (this._bodyInit = new Blob([this._bodyArrayBuffer]));
                else {
                  if (!n.arrayBuffer || (!ArrayBuffer.prototype.isPrototypeOf(t) && !o(t)))
    ...
    function(t, n, e) {
                      ...
                      function(t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              for (
                                r = s.length, o = new Array(r > 1 ? r - 1 : 0), i = 1;
                                i < r;
                                i++
                              )
                                o[i - 1] = s[i];
                              if (!(a = this.internals.callbacks['$'.concat(n)])) {
                                t.next = 12;
                                break;
                              }
                              return (
                            ...
                            case 8:
                              ...
                              console.error(
                                '%cError in '.concat(this.internals.rawOptions.title, '%c ') +
                                  'during event '.concat(n, '%c: ').concat(t.t0),
                                'font-weight: bold',
                                'font-weight: normal',
                            ...
                            case 12:
                              return (
                                (t.next = 14), (e = this.plugins).trigger.apply(e, [n].concat(o))
                              );
                            case 14:
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                                ...
                                (this.internals.rawOptions.debug &&
                                  (console.info(
                                    '%c'
                                      ...
                                      .concat(this.type, ') → ') +
                                      'Event %c'.concat(n, '%c · arguments [').concat(r, ']'),
                                    'font-weight: bold',
                                    'font-weight: normal',
                                    'font-weight: bold',
                                    'font-weight: normal; opacity: 0.5'
                                  ...
                                  console.time(
                                    ''.concat(n, ' on ').concat(this.internals.rawOptions.title) +
                            ...
                            case 9:
                              c = t.sent;
                            case 10:
                              return (t.next = 12), this.trigger.apply(this, [n].concat(r));
                            case 12:
                              return (
                                this.internals.rawOptions.debug &&
                                  console.timeEnd(
      ...
      var W = ['id', 'participant', 'participant_id'],
        H = W.concat(['sender', 'sender_type', 'sender_id', 'timestamp', 'meta']),
        $ = function(t) {
          return (
          ...
          function n() {
            ...
            !(function(t, n) {
              ...
              V(
                G(
                  G(
                    (t = (function(t, n) {
                      return !n || ('object' !== D(n) && 'function' != typeof n) ? G(t) : n;
            ...
            if (t.storage) {
              ...
              if (o)
                try {
                  (t.data = JSON.parse(o)),
                    (t.state = Object.assign.apply(Object, [{}].concat(B(t.data)))),
      ...
      function wt(t, n, e) {
        return (wt =
          'undefined' != typeof Reflect && Reflect.get
            ...
            : function(t, n, e) {
                var r = (function(t, n) {
                  for (; !Object.prototype.hasOwnProperty.call(t, n) && null !== (t = xt(t)); );
                  return t;
                })(t, n);
                if (r) {
                ...
                function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 6:
                        return (i = t.sent), (t.prev = 7), (t.next = 10), Mt(e, i);
                      case 10:
                        if ((a = t.sent)) {
                          t.next = 13;
                          break;
                        }
                        throw new Error('No data available after decoding '.concat(n));
                      case 13:
            ...
            kt(t, [
              {
                key: 'setAudioOrigin',
                value: function() {
                  this.audioSyncOrigin = et(this.timeline.controller.audioContext);
                },
              },
              {
                key: 'schedule',
                        ...
                        function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 9:
                                (o = t.sent),
                                  (e.audio[this.payload.src] = e.audio[this.payload.src] || o),
                                  (t.next = 16);
                                break;
                              case 13:
                                (t.prev = 13),
          ...
          function Component() {
            ...
            return (
              ...
              (t.options = new a.a(t.internals.rawOptions, {
                ...
                set: function(n, e, r) {
                  if (((t.internals.rawOptions[e] = r), t.status >= qn.prepared)) {
                    var o = mn(
                      r,
                      {
                            ...
                            switch ((t.prev = t.next)) {
                              ...
                              case 4:
                                return (
                                  ...
                                  (this.internals.timeline = new zt(this.internals.controller)),
                                  this.options.debug &&
                              ...
                              case 15:
                                return (
                                  ...
                                  (r = bn(this.internals.rawOptions, e, gn(this), e)),
                                  ...
                                  Object.keys(this.options.responses).forEach(function(t) {
                                    i.options.events[t] = function(n) {
                                      n.preventDefault(),
                                        i.respond(i.options.responses[t], ht(n.timeStamp));
                                    };
                                  }),
                                  ...
                                  null !== this.options.timeout &&
                                    ((o = 'frames' === this.options.timing.method ? gt : vt),
                                  ...
                                  (this.data = Tn({}, this.data, this.options.data)),
                                  (t.next = 27),
                                  this.triggerMethod('prepare', n)
                                );
                              case 27:
                                return (this.status = qn.prepared), (t.next = 30), this.preload();
                              case 30:
                                return (
                                ...
                                return (
                                  ...
                                  Promise.all(
                                    this.options.media.images.map(function(t) {
                                      return On(t, n.internals.controller.cache.images);
                                    })
                                  )
                                );
                              case 2:
                          ...
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 6:
                                ...
                                return t.abrupt('return', this.end('skipped', n, e));
                              case 10:
                                return (
                                        ...
                                        function(t) {
                                          for (;;)
                                            switch ((t.prev = t.next)) {
                                              ...
                                              case 3:
                                                o.internals.timeline.start(n + lt.frameInterval),
                        ...
                        function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (
                                  (n = u.length > 0 && void 0 !== u[0] ? u[0] : null),
                                  (e = u.length > 1 && void 0 !== u[1] ? u[1] : performance.now()),
                                ...
                                return (
                                  (i = function(t) {
                                    (a.internals.timestamps.switch = t),
                                      a.options.datastore.update(a.internals.logIndex, function(n) {
                                        return Tn({}, n, {
                                          time_switch: t,
                                          duration:
                                            'timeout' === n.ended_on ? t - n.time_show : n.duration,
                                        });
                                      }),
                                      dt(function() {
                                        return a.options.datastore.triggerMethod('idle');
                                      }),
                                      dt(function() {
                                        return a.epilogue();
                                      });
      ...
      var Dummy = (function(t) {
          function Dummy() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return Bn(this, Dummy), Rn(this, Mn(Dummy).call(this, Tn({ skip: !0 }, t)));
          }
                        ...
                        function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 2:
                                if (!(r = this.internals.iterator.next()).done) {
                                  t.next = 7;
                                  break;
                                }
                                return t.abrupt('return', this.end('completion', n, e));
                              case 7:
                                return (
                                  (o = Xn(r.value, 2)),
                                  ...
                                  t.abrupt('return', this.internals.currentComponent.run(n, e))
                                );
                              case 12:
                              case 'end':
                                return t.stop();
                ...
                return (
                  this.options.template instanceof Wn
                    ? (this.options.content = n.map(function(n) {
                        ...
                        return (e.options.parameters = Zn({}, e.options.parameters, n)), e;
                      }))
      ...
      var le = (function(t) {
        function Parallel() {
          ...
          return (
            ne(this, Parallel),
            oe(this, ie(Parallel).call(this, Zn({ content: [], mode: 'race' }, t)))
          );
        }
        return (
          ae(Parallel, Wn),
                    ...
                    return regeneratorRuntime.wrap(
                      function(t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (t.next = 2), se(this.options.content, this);
                            case 2:
                            case 'end':
                              return t.stop();
                          }
      ...
      function ve(t, n, e) {
        return (ve =
          'undefined' != typeof Reflect && Reflect.get
            ...
            : function(t, n, e) {
                var r = (function(t, n) {
                  for (; !Object.prototype.hasOwnProperty.call(t, n) && null !== (t = Oe(t)); );
                  return t;
                })(t, n);
                if (r) {
                  var o = Object.getOwnPropertyDescriptor(r, n);
      ...
      var je = (function(t) {
        function Screen(t) {
          return (
            me(this, Screen),
            xe(this, Oe(Screen).call(this, ye({ content: null, contentUrl: null }, t)))
          );
        }
        return (
          Se(Screen, Wn),
      ...
      var ke = (function(t) {
        function Frame() {
          ...
          return (
            ...
            xe(
              this,
              Oe(Frame).call(this, ye({ content: null, context: '', contextSelector: '' }, t))
            )
          );
        }
        return (
          ...
          function Screen() {
            ...
            return (
              ...
              ((t = ze(
                ...
                qe(Screen).call(
                  this,
                  He({ content: null, renderFunction: null, clearCanvas: !0 }, Je(n))
                )
                          ...
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (
                                ...
                                Xe.apply(this, [!1, this.options.canvas.parentElement]),
                                (t.next = 5),
                                this.options.content.run(n, e)
                              );
                            case 5:
          ...
          return regeneratorRuntime.wrap(
            function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    for (n = u.length, e = new Array(n), r = 0; r < n; r++) e[r] = u[r];
                    (o = e
                      .map(function(t) {
                              ...
                              switch ((t.prev = t.next)) {
                                case 0:
                                  return (
                                    (t.next = 2),
                                    e.map(function(t, e) {
                                      return t[Math.floor(n / (o[e + 1] || 1)) % t.length];
                                    })
                                  );
                                case 2:
                                case 'end':
            ...
            })(t, [
              {
                ...
                value: function(t, n) {
                  'prepare' === n
                    ...
                    : 'end' === n && window.removeEventListener('beforeunload', hr);
                },
              },
            ]),
            t

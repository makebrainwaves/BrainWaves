...
export const buildStroopTimeline = () => ({
  overview: 'Here is the placeholder for the overview of the Stroop task',
  background: 'Here is the background of the Stroop task',
  background_title: `Title`,
  protocol: 'Here is the protocol of the Stroop task',
  params: {
    trialDuration: 1000,
    nbTrials: 150,
    iti: 500,
    ...
    intro:
      'You will see the stroop task. Press 1 when a face appears and 9 for a house. Press any key to continue',

/**
 * Build script for the EEG viewer assets.
 *
 ...
 * preload and the viewer renderer page.
 *
 * Run automatically via the "predev" hook (so the viewer preload exists for
 * `npm run dev`) and the "postbuild" hook (for `npm run build`).
 */

...
export function MuseWearArt({ className }: { className?: string }) {
  return (
    <svg aria-hidden fill="none" viewBox="0 0 240 200" className={className}>
      <ellipse cx="120" cy="108" rx="62" ry="76" fill={GOLD_LIGHT} {...LINE} />
      <ellipse cx="58" cy="118" rx="9" ry="16" fill={GOLD_LIGHT} {...LINE} />
      <ellipse cx="182" cy="118" rx="9" ry="16" fill={GOLD_LIGHT} {...LINE} />
...
export function CrownWearArt({ className }: { className?: string }) {
  return (
    <svg aria-hidden fill="none" viewBox="0 0 240 200" className={className}>
      ...
      <ellipse cx="116" cy="112" rx="10" ry="16" fill={GOLD_LIGHT} {...LINE} />
      <path
